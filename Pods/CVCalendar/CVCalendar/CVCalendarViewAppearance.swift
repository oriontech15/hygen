...
public final class CVCalendarViewAppearance: NSObject {
    ...
    public var dayLabelPresentWeekdayTextColor: UIColor? = .colorFromCode(0xfd3955)
    ...
    public var dayLabelWeekdayHighlightedBackgroundColor: UIColor? = .colorFromCode(0xfec304)
    ...
    public var dayLabelWeekdaySelectedBackgroundColor: UIColor? = .colorFromCode(0x11b1b3)
    public var dayLabelWeekdaySelectedBackgroundAlpha: CGFloat? = 0.8
    public var dayLabelPresentWeekdaySelectedBackgroundColor: UIColor? = .colorFromCode(0xfd3955)
