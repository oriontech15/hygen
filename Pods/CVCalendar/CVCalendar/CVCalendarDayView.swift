...
extension CVCalendarDayView {
    ...
    public func setupDotMarker(option: Bool) {
        ...
        if let delegate = calendarView.delegate {
            if let shouldShow = delegate.dotMarker?(shouldShowOnDayView: self, option: option) , shouldShow {
