...
class CircleProgressView: UIView, CAAnimationDelegate {
    ...
    @IBInspectable public var trackColor: UIColor = AppearanceController.shared.mainColor.withAlphaComponent(0.2) {
        didSet {
    ...
    private func checkAndSetIBColors() {
        ...
        if !nonNilColors.isEmpty {
            ...
            set(colors: AppearanceController.shared.mainGradientColors)
        }
    }
    ...
    private class CircularProgressViewLayer: CALayer {
        ...
        var trackColor: UIColor = AppearanceController.shared.mainColor.withAlphaComponent(0.2)
        ...
        override func draw(in ctx: CGContext) {
            ...
            if !lerpColorMode && colorsArray.count > 1 {
                ...
                if colorsArray.isEmpty {
                    color = AppearanceController.shared.mainColor
