...
class StyleKit: NSObject {
    ...
    class func drawHygenLogo(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 1024, height: 1024), resizing: ResizingBehavior = .aspectFit) {
        ...
        do {
            ...
            do {
                context.saveGState()
                context.translateBy(x: 358.82, y: 650)
                context.rotate(by: 540 * CGFloat.pi/180)
                context.translateBy(x: -83.5, y: -100)
                ...
                rectangle39.addCurve(to: CGPoint(x: 101.32, y: 162.25), controlPoint1: CGPoint(x: 165, y: 147.26), controlPoint2: CGPoint(x: 119.63, y: 162.25))
                rectangle39.addCurve(to: CGPoint(x: 65.35, y: 162.25), controlPoint1: CGPoint(x: 83.02, y: 162.25), controlPoint2: CGPoint(x: 86.85, y: 162.25))
                rectangle39.addCurve(to: CGPoint(x: 1.11, y: 131.28), controlPoint1: CGPoint(x: 43.85, y: 162.25), controlPoint2: CGPoint(x: 2.49, y: 150.67))
                ...
                context.drawLinearGradient(CGGradient(colorsSpace: nil, colors: [
                    ...
                    start: CGPoint(x: 83.02, y: 162.25),
            ...
            do {
                context.saveGState()
                context.translateBy(x: 128.75, y: 513.94)
                context.rotate(by: 240 * CGFloat.pi/180)
                context.translateBy(x: -83.5, y: -100)
                ...
                rectangle41.addCurve(to: CGPoint(x: 99.71, y: 161.9), controlPoint1: CGPoint(x: 164.97, y: 148.42), controlPoint2: CGPoint(x: 143.01, y: 159.71))
                rectangle41.addLine(to: CGPoint(x: 99.71, y: 161.9))
                rectangle41.addCurve(to: CGPoint(x: 98.28, y: 161.91), controlPoint1: CGPoint(x: 99.23, y: 161.92), controlPoint2: CGPoint(x: 98.76, y: 161.93))
                rectangle41.addLine(to: CGPoint(x: 67.44, y: 160.8))
                rectangle41.addLine(to: CGPoint(x: 67.44, y: 160.8))
                rectangle41.addCurve(to: CGPoint(x: 66.44, y: 160.79), controlPoint1: CGPoint(x: 67.1, y: 160.79), controlPoint2: CGPoint(x: 66.77, y: 160.78))
                rectangle41.addCurve(to: CGPoint(x: 1.11, y: 131.28), controlPoint1: CGPoint(x: 24.35, y: 161.82), controlPoint2: CGPoint(x: 2.58, y: 151.98))
                ...
                context.drawLinearGradient(CGGradient(colorsSpace: nil, colors: [
                    ...
                    start: CGPoint(x: 83.02, y: 161.92),
                    end: CGPoint(x: 83.02, y: 0),
                    options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
                context.restoreGState()
                context.restoreGState()
            ...
            do {
                context.saveGState()
                context.translateBy(x: 128.51, y: 246.92)
                context.rotate(by: 300 * CGFloat.pi/180)
                context.translateBy(x: -83.5, y: -99.5)
                ...
                rectangle43.addCurve(to: CGPoint(x: 96.21, y: 163.74), controlPoint1: CGPoint(x: 164.96, y: 148.46), controlPoint2: CGPoint(x: 141.84, y: 160.36))
                rectangle43.addLine(to: CGPoint(x: 96.21, y: 163.74))
                rectangle43.addCurve(to: CGPoint(x: 95.13, y: 163.78), controlPoint1: CGPoint(x: 95.85, y: 163.76), controlPoint2: CGPoint(x: 95.49, y: 163.78))
                rectangle43.addLine(to: CGPoint(x: 67.29, y: 164.02))
                rectangle43.addLine(to: CGPoint(x: 67.29, y: 164.02))
                rectangle43.addCurve(to: CGPoint(x: 66.72, y: 164.02), controlPoint1: CGPoint(x: 67.1, y: 164.03), controlPoint2: CGPoint(x: 66.91, y: 164.02))
                rectangle43.addCurve(to: CGPoint(x: 1.11, y: 131.28), controlPoint1: CGPoint(x: 24.45, y: 162.92), controlPoint2: CGPoint(x: 2.58, y: 152.01))
                ...
                context.drawLinearGradient(CGGradient(colorsSpace: nil, colors: [
                    ...
                    start: CGPoint(x: 83.02, y: 164.02),
                    end: CGPoint(x: 83.02, y: 0),
                    options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
                context.restoreGState()
                context.restoreGState()
            ...
            do {
                context.saveGState()
                context.translateBy(x: 589.37, y: 245.9)
                context.rotate(by: 420 * CGFloat.pi/180)
                context.translateBy(x: -83.5, y: -99.5)
                ...
                rectangle45.addCurve(to: CGPoint(x: 101.7, y: 163.01), controlPoint1: CGPoint(x: 164.97, y: 148.42), controlPoint2: CGPoint(x: 143.67, y: 160.08))
                rectangle45.addLine(to: CGPoint(x: 101.7, y: 163.01))
                rectangle45.addCurve(to: CGPoint(x: 100.22, y: 163.04), controlPoint1: CGPoint(x: 101.21, y: 163.04), controlPoint2: CGPoint(x: 100.71, y: 163.05))
                rectangle45.addLine(to: CGPoint(x: 71.94, y: 162.48))
                rectangle45.addLine(to: CGPoint(x: 71.94, y: 162.48))
                rectangle45.addCurve(to: CGPoint(x: 71.62, y: 162.48), controlPoint1: CGPoint(x: 71.83, y: 162.48), controlPoint2: CGPoint(x: 71.73, y: 162.48))
                rectangle45.addCurve(to: CGPoint(x: 1.11, y: 131.28), controlPoint1: CGPoint(x: 26.09, y: 162.43), controlPoint2: CGPoint(x: 2.58, y: 152.03))
            ...
            do {
                ...
                rectangle47.addCurve(to: CGPoint(x: 99.45, y: 171.43), controlPoint1: CGPoint(x: 164.65, y: 158.79), controlPoint2: CGPoint(x: 115.89, y: 171.43))
                rectangle47.addCurve(to: CGPoint(x: 66.67, y: 171.43), controlPoint1: CGPoint(x: 83.02, y: 171.43), controlPoint2: CGPoint(x: 83.02, y: 171.43))
                rectangle47.addCurve(to: CGPoint(x: 1.11, y: 131.28), controlPoint1: CGPoint(x: 50.32, y: 171.43), controlPoint2: CGPoint(x: 3.32, y: 162.45))
                ...
                context.drawLinearGradient(CGGradient(colorsSpace: nil, colors: [
                    ...
                    start: CGPoint(x: 83.02, y: 171.43),
                    end: CGPoint(x: 83.02, y: 0),
                    options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
                context.restoreGState()
                context.restoreGState()
            ...
            do {
                context.saveGState()
                context.translateBy(x: 564.16, y: 499.23)
                context.rotate(by: 480 * CGFloat.pi/180)
                context.translateBy(x: -86, y: -131.5)
                
                /// Rectangle
                let rectangle49 = UIBezierPath()
                rectangle49.move(to: CGPoint(x: 18.01, y: 0))
                rectangle49.addLine(to: CGPoint(x: 150.03, y: 0))
                rectangle49.addLine(to: CGPoint(x: 150.03, y: 0))
                rectangle49.addCurve(to: CGPoint(x: 166.6, y: 16.44), controlPoint1: CGPoint(x: 159.13, y: 0), controlPoint2: CGPoint(x: 166.53, y: 7.34))
                rectangle49.addCurve(to: CGPoint(x: 166.46, y: 128.03), controlPoint1: CGPoint(x: 167.07, y: 72.11), controlPoint2: CGPoint(x: 167.02, y: 109.3))
                rectangle49.addCurve(to: CGPoint(x: 100.1, y: 167.95), controlPoint1: CGPoint(x: 165.84, y: 148.37), controlPoint2: CGPoint(x: 143.72, y: 161.68))
                rectangle49.addLine(to: CGPoint(x: 100.1, y: 167.95))
                rectangle49.addCurve(to: CGPoint(x: 97.99, y: 168.12), controlPoint1: CGPoint(x: 99.4, y: 168.05), controlPoint2: CGPoint(x: 98.7, y: 168.11))
                rectangle49.addLine(to: CGPoint(x: 71.05, y: 168.53))
                rectangle49.addLine(to: CGPoint(x: 71.05, y: 168.53))
                rectangle49.addCurve(to: CGPoint(x: 67.42, y: 168.18), controlPoint1: CGPoint(x: 69.83, y: 168.54), controlPoint2: CGPoint(x: 68.61, y: 168.43))
                rectangle49.addCurve(to: CGPoint(x: 0.89, y: 124.02), controlPoint1: CGPoint(x: 24.52, y: 159.23), controlPoint2: CGPoint(x: 2.34, y: 144.51))
                rectangle49.addCurve(to: CGPoint(x: 1.44, y: 16.04), controlPoint1: CGPoint(x: -0.46, y: 105.08), controlPoint2: CGPoint(x: -0.27, y: 69.09))
                rectangle49.addLine(to: CGPoint(x: 1.44, y: 16.04))
                rectangle49.addCurve(to: CGPoint(x: 18.01, y: 0), controlPoint1: CGPoint(x: 1.72, y: 7.1), controlPoint2: CGPoint(x: 9.06, y: 0))
                rectangle49.close()
                rectangle49.move(to: CGPoint(x: 18.01, y: 0))
                context.saveGState()
                context.translateBy(x: 3.59, y: 1.13)
                ...
                context.clip(using: .evenOdd)
                context.translateBy(x: -179.92, y: 0)
                do {
                    let baseZero = context.convertToDeviceSpace(CGPoint.zero).applying(baseTransform)
                    let baseOne = context.convertToDeviceSpace(CGPoint(x: 1, y: 1)).applying(baseTransform)
                    let baseOffset = context.convertToDeviceSpace(CGPoint(x: 179.92, y: 2)).applying(baseTransform)
                    let shadowOffset = CGSize(width: baseOffset.x - baseZero.x, height: baseOffset.y - baseZero.y)
                    let shadowBlur: CGFloat = 12 * min(baseOne.x - baseZero.x, baseOne.y - baseZero.y)
                    context.setShadow(offset: shadowOffset, blur: shadowBlur, color: UIColor(white: 0, alpha: 0.2).cgColor)
                }
                ...
                context.clip(using: .evenOdd)
                context.translateBy(x: -199.92, y: 0)
                do {
                    let baseZero = context.convertToDeviceSpace(CGPoint.zero).applying(baseTransform)
                    let baseOne = context.convertToDeviceSpace(CGPoint(x: 1, y: 1)).applying(baseTransform)
                    let baseOffset = context.convertToDeviceSpace(CGPoint(x: 199.92, y: -13)).applying(baseTransform)
                    let shadowOffset = CGSize(width: baseOffset.x - baseZero.x, height: baseOffset.y - baseZero.y)
                    let shadowBlur: CGFloat = 32 * min(baseOne.x - baseZero.x, baseOne.y - baseZero.y)
                    context.setShadow(offset: shadowOffset, blur: shadowBlur, color: UIColor(white: 0, alpha: 0.6).cgColor)
                }
                ...
                context.drawLinearGradient(CGGradient(colorsSpace: nil, colors: [
                    ...
                    start: CGPoint(x: 83.46, y: 168.53),
                    end: CGPoint(x: 83.46, y: 0),
                    options: [.drawsBeforeStartLocation, .drawsAfterEndLocation])
                context.restoreGState()
                context.restoreGState()
