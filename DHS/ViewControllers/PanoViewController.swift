...
class PanoViewController: UIViewController {
    ...
    func updateProgress() {
        ...
        let totalProgress = ProgressController.shared.panoProgress
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        PatientsController.shared.patientsWithXray(xrayType: .pano, completion: { (patients) in
...
extension PanoViewController: UITableViewDataSource, UITableViewDelegate {
