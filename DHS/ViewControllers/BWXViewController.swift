...
class BWXViewController: UIViewController {
    ...
    func updateProgress() {
        ...
        let totalProgress = ProgressController.shared.bwxProgress
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        PatientsController.shared.patientsWithXray(xrayType: .bwx, completion: { (patients) in
...
extension BWXViewController: UITableViewDataSource, UITableViewDelegate {
