...
class InjectionsViewController: UIViewController {
    ...
    func updateProgress() {
        ...
        let totalProgress = ProgressController.shared.injectionsProgress
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        PatientsController.shared.patientsWithInjections(completion: { (patients) in
...
extension InjectionsViewController: UITableViewDataSource, UITableViewDelegate {
